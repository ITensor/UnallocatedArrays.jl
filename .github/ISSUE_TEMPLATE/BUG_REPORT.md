---
name: UnallocatedArrays.jl bug report
about: Create a bug report to help us improve UnallocatedArrays.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("UnallocatedArrays")`:
```julia
julia> using Pkg; Pkg.status("UnallocatedArrays")
[YOUR OUTPUT HERE]
```
